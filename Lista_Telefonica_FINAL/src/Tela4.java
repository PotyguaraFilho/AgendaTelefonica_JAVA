...
public class Tela4 {
    ...
    @FXML
    void excluirContato(ActionEvent event) {
	String sql = "DELETE FROM DADOS WHERE NOME = ?";
        ...
        try {
            ...
            if(nomeTextField.getText().equals("")){
                ...
                exibirAlerta(Alert.AlertType.INFORMATION, "Sucesso", "Contato deletado com sucesso.");
            }
        } catch (Exception e) {
            exibirAlerta(Alert.AlertType.ERROR, "Erro", "Não foi possível deletar os dados.");
        }
    }
